...
<body>
	...
	<div class="section search-result-wrap">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="heading">Saved : Posts</div>
				</div>
			</div>
			<div class="row posts-entry">
				<div class="col-lg-8">
					...
					<div class="blog-entry d-flex blog-entry-search-item">
						<a href="single.php?post_id=<?= $post->id ?>" class="img-link me-4">
						...
						<div>
							...
							<p><a href="single.php?post_id=<?= $post->id ?>" class="btn btn-sm btn-outline-primary">Read More</a></p>
						</div>
					</div>
                    <?php endforeach; ?>
